...
export default class RestaurantIDB {
  constructor() {
    this._dbPromise = openDatabase();
  }

  restaurantsStore(selectedCurrencies, conversionRate) {
    let restaurantidb = this;

    restaurantidb.dbRestaurantPromise
    .then(function(db) {
      let tx = db.transaction('restaurant_info', 'readwrite');
      let store = tx.objectStore('restaurant_info');
      store.put(conversionRate, selectedCurrencies);
    })
  }

  saveRestaurants(selectedCurrencies, conversionRate) {
    let restaurantidb = this;
